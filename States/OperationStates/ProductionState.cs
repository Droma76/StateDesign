...
{
    internal class ProductionState : ConfigurationState
    {
        public Device Device { get; set; }

        public ProductionState(ConfigurationState configurationState)
        {
            this.Device = configurationState.Device;
            Initialize();
        }

        public ProductionState(Device device)
        {
            this.Device = device;
            Initialize();
        }
        ...
        public override void SetTestConfiguration()
        {
            ...
            this.Device.ConfigurationState = new TestState(this);
        }
    }
}